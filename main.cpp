...
// refugio.cpp
// Proyecto: Refugio de Animales
// Implementa: Herencia (Animal -> Perro, Gato), Composición (Animal tiene HistorialMedico),
// Agregación (Refugio guarda Animal*), Asociación (Veterinario revisa Animal).
// Compilar: g++ refugio.cpp -std=c++17 -o refugio
// Ejecutar: ./refugio
...
int main() {
    cout << "=== Demo: Refugio de Animales (Herencia, Composición, Agregación) ===" << endl;
